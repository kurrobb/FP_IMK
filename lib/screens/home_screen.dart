              ...
              children: [
                ...
                Padding(
                  ...
                  child: ListView.separated(
                    physics: const NeverScrollableScrollPhysics(),
                    shrinkWrap: true,
                    itemCount: data.todayTransactions.length,
                    separatorBuilder: (_, _) => const SizedBox(height: 8),
                    itemBuilder: (context, index) {
                      final tx = data.todayTransactions[index];
                ...
                Padding(
                  ...
                  child: ListView.separated(
                    physics: const NeverScrollableScrollPhysics(),
                    shrinkWrap: true,
                    itemCount: data.yesterdayTransactions.length,
                    separatorBuilder: (_, _) => const SizedBox(height: 8),
                    itemBuilder: (context, index) {
                      final tx = data.yesterdayTransactions[index];
                      return TransactionItem(
                        transaction: tx,
                        onTap: () => Navigator.push(
                          context,
